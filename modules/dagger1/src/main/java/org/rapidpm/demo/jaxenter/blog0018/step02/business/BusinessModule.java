...
package org.rapidpm.demo.jaxenter.blog0018.step02.business;
...
import org.rapidpm.demo.jaxenter.blog0018.step02.Main;
...
public class BusinessModule {
  ...
  @Provides
  SubService provideSubService(@Named("A") Lazy<SubService> subServiceA, @Named("B") Lazy<SubService> subServiceB) {
