...
package org.rapidpm.workshop.di.weld.se.v005;
...
public class MainV005 {
  ...
  public static class Service {
    ...
    public Service() {
      out.println(this.getClass().getSimpleName() + " - constructor = " + LocalDateTime.now());
    }
    ...
    private void postConstruct() {
      out.println(this.getClass().getSimpleName() + " - postconstruct = " + LocalDateTime.now());
    }
  }
